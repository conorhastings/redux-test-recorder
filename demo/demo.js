...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dist = __webpack_require__(177);
	...
	var Counter = function Counter(_ref2) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'p',
	      { style: pStyle },
	      'To Use, press record button, interact with counter, and press record again'
	    ),
	    _react2.default.createElement(
	      'button',
	    ...
	    _react2.default.createElement(_dist.TestRecorder, record.props)
	  );
	};
	
	var ConnectedCounter = (0, _reactRedux.connect)(function (state) {
	  return { count: state };
	})(Counter);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TestRecorder = undefined;
	
	var _testRecorder = __webpack_require__(178);
	
	var _testRecorder2 = _interopRequireDefault(_testRecorder);
	...
	var reduxRecord = function reduxRecord(reducer) {
	  ...
	  var getRecordingStatus = function getRecordingStatus() {
	    return recording;
	  };
	  var shouldShowTest = function shouldShowTest() {
	    return showingTest;
	  };
	    ...
	    return function (next) {
	      return function (action) {
	        ...
	        if (recording) {
	          ...
	          actions.push({ action: action, nextState: nextState });
	        }
	      };
	    };
	  };
	  var props = { getRecordingStatus: getRecordingStatus, startRecord: startRecord, stopRecord: stopRecord, getTest: getTest, shouldShowTest: shouldShowTest, hideTest: hideTest };
	  return { middleware: middleware, props: props };
	};
	exports.TestRecorder = _testRecorder2.default;
	exports.default = reduxRecord;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recordComponent = __webpack_require__(179);
	
	var _recordComponent2 = _interopRequireDefault(_recordComponent);
	
	var _displayTest = __webpack_require__(180);
	...
	var TestRecorder = function (_React$Component) {
	  _inherits(TestRecorder, _React$Component);
	
	  function TestRecorder() {
	    _classCallCheck(this, TestRecorder);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TestRecorder).call(this));
	  ...
	  _createClass(TestRecorder, [{
	    key: 'onClick',
	    value: function onClick(recordingStatus) {
	      var _this2 = this;
	
	      var click = recordingStatus ? this.props.stopRecord : this.props.startRecord;
	      if (!recordingStatus) {
	        this.interval = setInterval(function () {
	          _this2.setState({
	            hovered: !_this2.state.hovered
	          });
	        }, 500);
	      } else {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_recordComponent2.default, {
	          onClick: function onClick(recordingStatus) {
	            return _this3.onClick(recordingStatus);
	          },
	        ...
	        _react2.default.createElement(_displayTest2.default, {
	...
	var Record = function (_React$Component) {
	  ...
	  _createClass(Record, [{
	    ...
	    value: function render() {
	      ...
	      var getRecordingStatus = _props.getRecordingStatus;
	      ...
	      return _react2.default.createElement(
	        'div',
	        {
	          ...
	          onClick: function onClick() {
	            return _this2.props.onClick(getRecordingStatus());
	          }
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DisplayTest = function (_React$Component) {
	  _inherits(DisplayTest, _React$Component);
	
	  function DisplayTest() {
	    _classCallCheck(this, DisplayTest);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(DisplayTest).apply(this, arguments));
	  }
	
	  _createClass(DisplayTest, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props;
	      var getTest = _props.getTest;
	      var shouldShowTest = _props.shouldShowTest;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { contentEditable: true, onKeyUp: onKeyPress, style: style },
	            getTest()
	          )
	        )
	      );
