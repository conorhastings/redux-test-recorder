...
/***/ function(module, exports, __webpack_require__) {
	...
	var decrement = function decrement(num) {
	...
	var Counter = function Counter(_ref2) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'button',
	      { onClick: function onClick() {
	          return dispatch(decrement(count));
	        } },
	      '-'
	    ),
	    _react2.default.createElement(_dist.Record, record.recordingProps)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recordComponent = __webpack_require__(178);
	...
	var reduxRecord = function reduxRecord(reducer) {
	  ...
	  var recordingProps = { getRecordingStatus: getRecordingStatus, startRecord: startRecord, stopRecord: stopRecord };
	  ...
	  return { middleware: middleware, getTests: getTests, recordingProps: recordingProps };
	};
	
	exports.Record = _recordComponent2.default;
